...
class _MyHomePageState extends State<MyHomePage> {
  ...
  bool pengirimanDalamKota = false;
  bool menerimaRetur = false;
  ...
  void navigateToSecondPage() {
    ...
    Navigator.pushNamed(
      ...
      arguments: {
        ...
        'jenisKendaraan': selectedJenisKendaraan.toString(),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Avanza'),
                  Checkbox(
                    value: pengirimanDalamKota,
                    onChanged: (value) {
                      setState(() {
                        pengirimanDalamKota = value ?? false;
                      });
                    },
                  ),
                ],
